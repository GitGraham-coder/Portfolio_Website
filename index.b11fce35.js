...
const mainFn = ()=>{
    ...
    if (window.pageYOffset + window.innerHeight >= progress.offsetTop) document.querySelectorAll(".progress-percent").forEach((el, i)=>{
...
//# sourceMappingURL=index.b11fce35.js.map
